...
export var bomb: PackedScene = preload("res://scenes/characters_overlay/bomb/bomb.tscn")
export var box_coin: PackedScene = preload("res://scenes/characters_overlay//box_coin/box_coin.tscn")
